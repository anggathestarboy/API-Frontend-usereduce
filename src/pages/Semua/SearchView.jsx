...
const SearchView = ({state, loading, fungsiPerubahan, q}) => {
  return (
    <div>
      <div className="flex items-center justify-center mt-7">
  <fieldset className="border border-gray-300 rounded-lg p-4 w-full max-w-md">
    <legend className="px-2 text-sm font-semibold text-gray-700">
      What’s product do you like?
    </legend>
    <input
      value={q}
      onChange={fungsiPerubahan}
      type="text"
